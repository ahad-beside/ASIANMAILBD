...
class Advertisement extends CActiveRecord {
    ...
    public $availablePositions = array(
        ...
        'Home Page F1'=>'Home Page F1',
        'Home Page F2'=>'Home Page F2',
        'Home Page Sidebar'=>'Home Page Sidebar',
        
        'Category Page F1'=>'Category Page F1',
        'Category Page F2'=>'Category Page F2',
        'Category Page Sidebar'=>'Category Page Sidebar',
        
        'Article Page F1'=>'Article Page F1',
        'Article Page F2'=>'Article Page F2',
        'Article Page Sidebar'=>'Article Page Sidebar',
        
        'M Home Page F1'=>'M Home Page F1',
    ...
    public function rules() {
        ...
        return array(
            array('name, type, sort_order, position, update_time, update_by', 'required'),
            array('sort_order, update_by', 'numerical', 'integerOnly' => true),
            array('name, image', 'length', 'max' => 100),
            array('link', 'length', 'max' => 255),
            array('image, link, script', 'safe'),
    ...
    public function getAdvertisement($pos,$limit=1000){
