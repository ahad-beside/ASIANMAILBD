...
class Category extends CActiveRecord {
    ...
    public static function makeLink($id) {
        ...
        if (count($info) > 0) {
            ...
            return Yii::app()->createUrl('//category/' . $id . '/' . Yii::app()->easycode->seoUrl(trim($info->description)));
        } else {
            return '#';
        }
    }
     ...
     public static function makemobileLink($id) {
        ...
        if (count($info) > 0) {
            //return Yii::app()->createUrl('//category/' . $id, array('name' => $info->name));
            return Yii::app()->createUrl('//mobile/category/' . $id . '/' . Yii::app()->easycode->seoUrl(trim($info->description)));
        } else {
            return '#';
        }
    }
