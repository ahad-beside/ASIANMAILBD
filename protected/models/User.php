...
class User extends CActiveRecord {
    ...
    public function rules() {
        ...
        return array(
            array('password, email, role, first_name, last_name, active', 'required'),
            array('email', 'email'),
            ...
            //array('username,first_name, last_name, phone, email_verified, verification_code, forgot_pass_code', 'safe'),
            // The following rule is used by search().
            // @todo Please remove those attributes that should not be searched.
            array('id, username, password, active, email, first_name, last_name, phone, lastLogin', 'safe', 'on' => 'search'),
        );
    }
