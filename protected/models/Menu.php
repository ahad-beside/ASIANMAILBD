...
class Menu extends CActiveRecord {
    ...
    public function rules() {
        ...
        return array(
            ...
            array('sort_order,heading,quick_menu','safe'),
    ...
    public function makemobileLink($id){
        $info = self::model()->findByPk((int)$id);
        if($info->type=='category')
            return Category::model ()->makemobileLink($info->additional_id);
       else if ($info->type == 'page')
            return Page::model()->makemobileLink($info->additional_id);
        else
            return $info->additional_id;
    }
