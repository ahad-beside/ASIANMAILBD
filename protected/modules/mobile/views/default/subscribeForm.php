    ...
    <div class="col-md-12" >
            <?= CHtml::ajaxSubmitButton("Subscribe", Yii::app()->createUrl("//site/addSubscribtion"), array('beforeSend' => 'function (data){
                                ...
                                if(data.res=="0"){
                                   ...
                                   $("#subscriber-list-form").attr("style","text-align: center; font-size: 130px");
                                   $("#subscriber-list-form").html("<i class=\"fa fa-check\"></i><br><span style=\"font-size:15px\">Thank you. Your Email has been successfully subscribed for newsletter</span>");
                                   $("#subscribetion-btn").removeAttr("disabled");
                                }
