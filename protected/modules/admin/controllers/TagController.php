...
class TagController extends Controller {
    ...
    public function actionCreate() {
        ...
        if (isset($_POST['Tag'])) {
            ...
            if ($model->save()) {
                Yii::app()->user->setFlash('success', "Success: Tag created successfully");
        ...
        $model->sort_order = Yii::app()->easycode->getLastSortingNumber('Tag', 'sort_order');
    ...
    public function actionUpdate($id) {
        ...
        if (isset($_POST['Tag'])) {
            ...
            if ($model->save()) {
                Yii::app()->user->setFlash('success', "Tag updated successfully");
                $this->redirect(array('admin'));
            } else {
                Yii::app()->user->setFlash('warning', "Warning: Please check the form carefully for errors!");
            }
