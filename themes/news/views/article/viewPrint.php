...
<div class="container">
    <div class="row margin-top">
        <div class="col-md-12" style="text-align: center">
            <a href="<?= Yii::app()->homeUrl ?>"><img src="<?php echo Yii::app()->theme->baseUrl ?>/assets/images/logo.png" alt="asianmailbd.com" height="100"></a><br/><?= Yii::app()->easycode->ShowBanglaDate(date('l, d, F, Y')) ?>
        </div>
